        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-x-[54px]">
          <div className="w-full">
            ...
            <div className="hero-rise hero-d3 mt-7 flex flex-col items-start gap-3 sm:mt-8 sm:flex-row sm:items-center sm:gap-3.5">
              <a
                href="/predictors"
                className="btn-press flex h-[50px] w-fit items-center justify-center gap-2.5 rounded-lg bg-brand px-5 text-[15px] font-semibold text-white transition-opacity hover:opacity-95 sm:h-[52px]"
              >
              ...
              <a
                ...
                className="btn-press flex h-[50px] w-fit items-center justify-center gap-2.5 rounded-lg border border-[#DCE3EC] bg-white px-5 text-[15px] font-semibold text-navy shadow-[0_1px_2px_rgba(16,24,45,0.05)] transition-colors hover:bg-sky sm:h-[52px]"
              >
